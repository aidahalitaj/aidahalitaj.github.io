window.addEventListener("DOMContentLoaded", async function () {
    ...
    document.querySelectorAll(".stack-card").forEach(async function (el) {
        ...
        el.innerHTML = `
        <div style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji; border-radius: 6px; line-height: 1.5; padding: 16px; font-size: 14px; color: black; background-color: #d2d2d2;">
